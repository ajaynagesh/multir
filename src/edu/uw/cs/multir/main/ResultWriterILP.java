...
public class ResultWriterILP {

	// allow only a single output label per entity pair, instead of multiple
	static boolean singleBestOnly = false;
	
	public static void write(String dir, String trainType, String scoring) throws IOException {
		...
		ResultWriterILP.eval(dir + File.separatorChar + "mapping", test, params, ps, trainType, scoring);
		ps.close();
	}
